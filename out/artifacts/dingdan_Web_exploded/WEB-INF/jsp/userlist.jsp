...
<div class="right">
	...
	<div class="providerAdd">
		<div>
			<label>用户编码：</label> <input type="text" id="v_userCode"
				readonly="readonly">
		</div>
		<div>
			<label>用户名称：</label> <input type="text" id="v_userName"
				readonly="readonly">
		</div>
		<div>
			<label>用户性别：</label> <input type="text" id="v_gender"
				readonly="readonly">
		</div>
		<div>
		...
		<div>
			<label>用户电话：</label> <input type="text" id="v_phone"
				readonly="readonly">
		</div>
		<div>
