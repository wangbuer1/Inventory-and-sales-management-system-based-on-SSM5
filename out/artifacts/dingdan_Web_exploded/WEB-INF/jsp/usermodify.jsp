...
<div class="right">
	...
	<div class="providerAdd">
		<form id="userForm" name="userForm" method="post"
			...
			<div>
				<label for="userName">用户编码：</label> <input type="text"
			...
			<div>
				...
				<c:choose>
					...
					<c:otherwise>
						<img src="${user.idPicPath}" style="width:100px;height:80px" />
					</c:otherwise>
				</c:choose>
			</div>
			<div>
